...
class SiteNav {
  ...
  init() {
    ...
    this.scrollTolinks = [...$$('a[data-scroll-to]', this.el)];
  ...
  _bindEvents() {
    ...
    if (this.scrollTolinks) on(this.scrollTolinks, "click", this._handleScrollTo);
  ...
  _unbindEvents() {
    ...
    if (this.scrollTolinks) off(this.scrollTolinks, "click", this._handleScrollTo);
